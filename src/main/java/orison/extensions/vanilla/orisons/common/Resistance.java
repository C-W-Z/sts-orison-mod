...
// 抵抗
@SaveIgnore
public class Resistance extends AbstractOrison {

    public static final String ID = makeID(Resistance.class.getSimpleName());
    ...
    public void onUse(AbstractCard card, AbstractCreature target, UseCardAction action) {
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player,
                new ArtifactPower(AbstractDungeon.player, getModifiedValue(0))));
    }

    @Override
    public AbstractOrison newInstance(boolean adv) {
        return new Resistance(adv);
    }
