...
public class MorimensModExtension implements OrisonExtension {
    ...
    public static List<AbstractOrison> commonAwakenerOrisons = Arrays.asList();
    public static List<AbstractOrison> chaosOrisons = Arrays.asList();
    public static List<AbstractOrison> aequorOrisons = Arrays.asList();
    public static List<AbstractOrison> caroOrisons = Arrays.asList();
    public static List<AbstractOrison> ultraOrisons = Arrays.asList();
